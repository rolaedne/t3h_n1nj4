...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/t3h_n1nj4_redux

dist/Release/GNU-Linux-x86/t3h_n1nj4_redux: ${OBJECTFILES}
...
${OBJECTDIR}/nmy.o: nbproject/Makefile-${CND_CONF}.mk nmy.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/nmy.o nmy.c
...
${OBJECTDIR}/plyr.o: nbproject/Makefile-${CND_CONF}.mk plyr.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/plyr.o plyr.c
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/t3h_n1nj4_redux
